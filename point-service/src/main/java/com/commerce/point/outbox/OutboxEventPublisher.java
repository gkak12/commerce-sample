...
public class OutboxEventPublisher {
    ...
    @SchedulerLock(name = "outbox_publisher_point", lockAtMostFor = "PT10S", lockAtLeastFor = "PT4S")
    public void publishPendingEvents() {
        processEvents(outboxEventRepository.findTop100ByStatusOrderByCreatedAtAsc(OutboxStatus.PENDING));
    }

    @Scheduled(fixedDelay = 60000)
    @SchedulerLock(name = "outbox_retry_point", lockAtMostFor = "PT30S", lockAtLeastFor = "PT10S")
