package com.commerce.point.config;
...
public class KafkaConfig {
    ...
    @Bean
    public org.apache.kafka.clients.admin.NewTopic pointEarnedTopic() {
        return TopicBuilder.name(com.commerce.common.kafka.KafkaTopic.POINT_EARNED).partitions(3).replicas(1).build();
    }
